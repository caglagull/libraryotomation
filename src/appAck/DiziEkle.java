...
public class DiziEkle extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtDesc, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String desc=txtDesc.getText().trim();
        try {
            String query="INSERT INTO `dizi` (`did`, `dtitle`, `ddesc`) VALUES (NULL, ?, ?);";
            PreparedStatement pre=db.preBaglan(query);
            pre.setString(1, title);//INSERT sorgusundaki 1.parametre title demek
            pre.setString(2, desc); //sorgudaki 2.parametre desc demek
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiziEkle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
